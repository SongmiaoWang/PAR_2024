...
class Block(nn.Module):
    ...
    def forward(self, batch_data, saver=None):

        global graph_boxes_features
        images_in, boxes_in, bboxes_num_in, bboxes_social_group_id_in, seq_id, frame_id, clp_all_f_imgs, clp_all_f_bboxs, \
        clp_all_f_bbox_nums, clp_all_f_p_ids, clp_key_f_pos, clp_traj_graph, clp_graph_order = batch_data
        ...
        for b in range(B):
            ...
            # relation_graph_gt = torch.from_numpy(relation_graph_gt).to(boxes_features.device)
